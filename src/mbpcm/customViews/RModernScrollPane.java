 ...
 *
 */
public class RModernScrollPane extends RTextScrollPane {
    ...
    public RModernScrollPane(Component view) {
        this(view, VERTICAL_SCROLLBAR_AS_NEEDED, HORIZONTAL_SCROLLBAR_AS_NEEDED);
    }

    public RModernScrollPane(int vsbPolicy, int hsbPolicy) {
        this(null, vsbPolicy, hsbPolicy);
    }

    public RModernScrollPane(Component view, int vsbPolicy, int hsbPolicy) {
